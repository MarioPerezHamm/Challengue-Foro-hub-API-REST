...
import com.aluracursos.Challenge_Foro_Hub.domain.usuario.DatosAutentificacionUsuario;
import com.aluracursos.Challenge_Foro_Hub.domain.usuario.Usuario;
import com.aluracursos.Challenge_Foro_Hub.infra.security.DatosTokenJWT;
...
public class AutenticacionController {
    ...
    @PostMapping
    public ResponseEntity iniciarSesion(@RequestBody @Valid DatosAutentificacionUsuario datos){
